        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                <article>
                	...
                	<header>
                	<h2>Next Four Times for Submitted Bus Stop</h2>
                	</header>
                	<section>
						<s:property value="futureTimes[0]"/>, <s:property value="futureTimes[1]"/>, <s:property value="futureTimes[2]"/>, <s:property value="futureTimes[3]"/>.
					</section>
				</article>
